"""Checkpointed full-corpus event extraction after the v3.4 reliability gate."""
...
from score_llm_event_extractor_v3_4 import api, model_digest, parse_batch, sha256, write_json
...
def main() -> None:
    ...
    for key in ("prompt", "response_schema", "postprocessor", "stage1_gate", "producer"):
        frozen = contract[key]
