...
from audit_sec_rss_archive_extraction_gate_v14 import audit
...
class SecRssV14ExtractionGateTests(unittest.TestCase):
    def payloads(self, minimum: int = 2):
        times = ("2025-01-01T00:00:00+00:00", "2025-01-02T00:00:00+00:00")
        corpus = {"corpus_id": "sec-rss-internet-archive-v14", "records": [source(str(i), t) for i, t in enumerate(times)]}
        ...
        predeclared = {
            "experiment_id": "test", "corpus": {"id": "sec-rss-internet-archive-v14", "information_time": "archive_capture_at"},
