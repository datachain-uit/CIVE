"""Checkpointed full-corpus event extraction after the v3.3 reliability gate."""
...
from score_llm_event_extractor_v3 import api, model_digest, parse_batch, sha256, write_json
