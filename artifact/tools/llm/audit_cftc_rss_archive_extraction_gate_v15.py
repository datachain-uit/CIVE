"""Audit the completed v15 extraction and enforce its outcome-blind data gate."""
...
EXTRACTION = ROOT / "paper/input/results/llm/v15/cftc_rss_archive_predictive_v15/extraction/extraction.json"
PROGRESS = ROOT / "paper/input/results/llm/v15/cftc_rss_archive_predictive_v15/extraction/extraction_progress.json"
OUTPUT = ROOT / "paper/input/results/llm/v15/cftc_rss_archive_predictive_v15/extraction_gate.json"
...
def audit(corpus_payload: dict, extraction_payload: dict, predeclared: dict) -> dict:
    ...
    return {
        "schema_version": "cftc-rss-archive-extraction-data-gate-v15",
