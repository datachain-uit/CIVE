param(
    [string]$RunRoot = (Join-Path (Split-Path -Parent (Split-Path -Parent $PSScriptRoot)) 'runtime\nemotron3_nano4b_challenger')
)
...
$candidateId = 'nemotron3_nano4b'
$modelArtifactStem = 'nemotron3_nano4b'
$config = Join-Path $RunRoot 'configs\llm_nemotron3_nano4b_challenger_v1_development.json'
