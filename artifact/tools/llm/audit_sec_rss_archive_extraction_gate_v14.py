"""Audit the completed v14 extraction and enforce its outcome-blind data gate."""
...
EXTRACTION = ROOT / "paper/input/results/llm/v14/sec_rss_archive_predictive_v14/extraction/extraction.json"
PROGRESS = ROOT / "paper/input/results/llm/v14/sec_rss_archive_predictive_v14/extraction/extraction_progress.json"
OUTPUT = ROOT / "paper/input/results/llm/v14/sec_rss_archive_predictive_v14/extraction_gate.json"
...
def audit(corpus_payload: dict, extraction_payload: dict, predeclared: dict) -> dict:
    ...
    return {
        "schema_version": "sec-rss-archive-extraction-data-gate-v14",
