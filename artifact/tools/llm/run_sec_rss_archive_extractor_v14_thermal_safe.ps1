...
$runner = Join-Path $PSScriptRoot 'resume_sec_rss_archive_extractor_v14.py'
$output = Join-Path $workspace 'paper\input\results\llm\v14\sec_rss_archive_predictive_v14\extraction'
...
try {
    while ($true) {
        ...
        $stdout = Join-Path $logs 'sec_rss_v14.stdout.log'
        $stderr = Join-Path $logs 'sec_rss_v14.stderr.log'
