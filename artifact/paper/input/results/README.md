...
- `experiment_ledger/`: sổ cái tổng hợp Tech, LLM và Tech+LLM, là điểm tra cứu đầu tiên cho con người. Audit hiện có chuỗi `LLM-001`–`LLM-086` và kết quả `HYB-001`–`HYB-009`; HYB-007 có tail-risk attenuation nhưng formal gate FAIL, HYB-008 conditional downside information FAIL trước policy, HYB-009 model substitution FAIL economic gate. V13 chưa từng được gán nên không tạo experiment giả để lấp số.
...
- `runtime/glm4_9b_challenger/`: predeclaration và Stage 1 artifact của LLM-085 và LLM-086. Exact GLM-4 9B Q3_K_M fail event-extractor contract ở v21; independent daily-information-set challenger cũng fail-fast ngay record đầu vì JSON không hợp lệ. Không nhánh nào được nối outcome hoặc HYB.
- `hybrid/`: predeclaration và kết quả HYB-001/HYB-002 cùng audit HYB-003, external transfer HYB-004, feasibility HYB-005, rank-pair transfer HYB-006, historical risk attenuation HYB-007, conditional downside gate HYB-008 và model-substitution HYB-009. HYB-009 giữ cùng canonical Tech-Control/policy cho FinBERT, CryptoBERT và Ministral; cả ba economic gate FAIL. CryptoBERT có tail-risk attenuation mô tả tốt hơn shuffled/constant sizing nhưng lợi nhuận giảm và risk audit là hậu outcome. Bản HYB-007 prospective tạo sai phạm vi được giữ dưới tên `WITHDRAWN_SCOPE_ERROR`. Không gọi các kết quả này là replication/validation/holdout/live evidence.
...
- Sổ cái giữ thứ tự LLM-only trước Tech+LLM. Diagnostic task-compatibility LLM-086 nằm sau LLM-085; MSA-001 nằm sau LLM-086 và trước HYB-001; EXT-002/HYB-009 kết thúc nhóm Tech+LLM hiện tại.
